...
class Ecp(BaseANN):
    ...
    def fit(self, dataset):
        ...
        self.cluster_file_path = index_dir + "ecp_clusters.bin"
    ...
    def query(self, X, k):
        ...
        result = ecp.ecp_process_query(queries, self.index_file_path, self.meta_data_file_path, self.cluster_file_path, self.k, self.b, self.L)
        self.res = result
