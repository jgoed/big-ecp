...
int main()
{
    ...
    ecp::ecp_create_index(dataset_file_path, data_folder_path, L, desired_cluster_size);
    ecp::ecp_assign_points_to_cluster(dataset_file_path, data_folder_path, chunk_size);
    auto results = ecp::ecp_process_query(dummy, data_folder_path, k, b, L);
